#' @title The United States Chemical Data Reporting Inventory, 2016
#'   Manufacturing Information
#' @description Note that the .csv file needs to be manually downloaded
#'   from the official website:
#'   https://www.epa.gov/chemical-data-reporting
#'
#' @format A data frame with 43,813 rows and 5 variables:
#' \describe{
#'   \item{consolidated_id}{(Integer) The CDR internal identifier number}
